...
// Mirrors DeleteUserModal, but shows the SP category instead of the partner
// sub-type — the partner version would label every provider "Vendor".
export function DeleteProviderModal({
  ...
  const category = provider?.providerProfile?.category;
      ...
      <div className="space-y-4">
        ...
        <div className="px-3 py-3 rounded-xl bg-brand-red-muted border border-brand-red/20 space-y-1">
          ...
          <p className="text-[12px] text-brand-red/80 leading-relaxed">
            This will delete the user&apos;s account, all service requests, wallet
            history, KYC documents, images stored in R2, support tickets, and every
            other record associated with this user. There is no recovery.
          </p>
        </div>
